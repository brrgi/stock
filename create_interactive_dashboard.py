...
def get_available_dates():
    ...
    files = [f for f in os.listdir('weekly_data') if f.startswith('signals_') and f.endswith('.json')]
...
"""
    ...
    # HTML 파일 저장
    with open('dashboard_interactive.html', 'w', encoding='utf-8') as f:
        f.write(html)

    print(f"대시보드 생성 완료: dashboard_interactive.html")
    print(f"사용 가능한 날짜: {len(dates)}개")
    return 'dashboard_interactive.html'
